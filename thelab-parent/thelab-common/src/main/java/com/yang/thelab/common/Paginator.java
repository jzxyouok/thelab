 ...
 * </p>
 * @author nibo
 * @version $Id: Paginator.java, v 0.1 2015年11月2日 上午11:29:25 nibo Exp $
 */
public class Paginator<T> implements Serializable, Cloneable {
    ...
    private List<T>           pdate = new ArrayList<T>();
    ...
    public void setPdate(List<T> pdate) {
        this.pdate = pdate;
    }

    public List<T> getPdate() {
        return pdate;
    }
}
